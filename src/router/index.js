...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        name: 'Guide',
        meta: { title: 'bucket', icon: 'guide', noCache: true }
      }
    ]
    // meta: {
    //   showMenu: true,
    //   sort: 1,
    //   privilege: ['s3:ListAllMyBuckets']
    // }
  },
  {
    path: '/fileSystem',
    ...
    children: [
      {
        ...
        name: 'FileSystem',
        meta: { title: 'FileSystem', icon: 'guide', noCache: true }
      }
    ]
    // meta: {
    //   showMenu: true,
  ...
  {
    path: '/objectResources/ObjectResource',
    name: 'ObjectResource',
    component: Layout,
    meta: {
    ...
    children: [
      {
        ...
        name: 'ObjectResource',
        meta: { title: 'ObjectResource', icon: 'guide', noCache: true }
      },
      {
        path: 'LoadGroup',
        component: () => import('@/components/page/objectStorage/objectResource/loadGroup'),
        name: 'LoadGroup',
        meta: { title: 'LoadGroup', icon: 'guide', noCache: true }
      },
      {
        path: 'loadGroupRoute',
        component: () => import('@/components/page/objectStorage/objectResource/loadGroupRoute'),
        name: 'loadGroupRoute',
        meta: { title: 'loadGroupRoute', icon: 'guide', noCache: true }
      }
    ]
  },
  {
    path: '/resourceManagement/migrationResource',
    name: 'migrationResource',
    component: Layout,
    meta: {
      title: 'migrationResource',
      icon: 'el-icon-s-help'
    },
    children: [
      {
        ...
        name: 'resource',
        meta: { title: 'resource', icon: 'guide', noCache: true }
      },
      {
        path: 'taskManagement',
        component: () => import('@/components/page/task'),
        name: 'taskManagement',
        meta: { title: 'taskManagement', icon: 'guide', noCache: true }
      }, {
        path: 'removeManagement',
        component: () => import('@/components/page/removeData'),
        name: 'removeManagement',
        meta: { title: 'removeManagement', icon: 'guide', noCache: true }
      }
    ]
  },
    ...
    children: [
      {
        ...
        name: 'Users',
        meta: { title: 'Users', icon: 'guide', noCache: true }
      },
      {
      ...
      },
      {
        ...
        name: 'Group',
        meta: { title: 'Group', icon: 'guide', noCache: true }
      },
      {
    ...
    children: [
      {
        ...
        meta: { title: 'bucketCacheConfig', icon: 'guide', noCache: true }
      },
      {
        path: 'bucketCacheList',
        component: () => import('@/components/page/bucketCache/bucketCacheList'),
        name: 'bucketCacheList',
        meta: { title: 'bucketCacheList', icon: 'guide', noCache: true }
      }
    ]
  },
    ...
    children: [
      {
        ...
        name: 'restoreRecords',
        meta: { title: 'restoreRecords', icon: 'guide', noCache: true }
      },
      {
        path: 'deleteMark',
        component: () => import('@/components/page/dataRecycle/deleteMark'),
        name: 'deleteMark',
        meta: { title: 'deleteMark', icon: 'guide', noCache: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'auditLogs',
        meta: { title: 'operationLog', icon: 'guide', noCache: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        component: () => import('@/components/page/operation/auditLogs'),
        name: 'auditLogs',
        meta: { title: 'globalConifg', icon: 'guide', noCache: true }
      }
    ]
  }
  // {
  //   path: 'objectResources/loadGroupRoute',
  //   name: 'loadGroupRoute',
  //   component: '12',
  //   meta: {
  //     showMenu: true,
  //     // noCache: true,
  //     privilege: ['isAdmin']
  //     // privilege: ['admin:LoadGroupController']
  //   }
  // }
]
